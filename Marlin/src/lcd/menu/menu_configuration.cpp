...
void menu_config_repeatprint() {
  ...
  EDIT_ITEM(uint16_3, MSG_REPEATPRINT_LENGTH, &ReprintManager.Push_length, 0, MAX_REPRINT_ARM_LENGHT);
	...
	EDIT_ITEM(float51, MSG_REPEATPRINT_BASEHEIGTH, &ReprintManager.RePrintBaseHeigth,  MIN_REPEATPRINT_BASE_HEIGTH, MAX_REPEATPRINT_BASE_HEIGTH);
