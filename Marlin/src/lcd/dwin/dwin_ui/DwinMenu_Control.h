...
#define	CONFIG_CASE_TOTAL (CONFIG_TUNE_CASE_TOTAL + BOTH(OPTION_WIFI_MODULE, OPTION_WIFI_BAUDRATE) + ENABLED(OPTION_LASER) + ENABLED(SPINDLE_FEATURE) + ENABLED(SWITCH_EXTRUDER_MENU) + BOTH(MIXING_EXTRUDER, OPTION_MIXING_SWITCH) + HAS_OFFSET_MENU + EITHER(PID_EDIT_MENU, PID_AUTOTUNE_MENU) + ABL_GRID*2 + HAS_PROBE_XY_OFFSET)
