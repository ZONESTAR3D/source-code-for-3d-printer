...
#define	LEVELING_CASE_TOTAL	(1 + HAS_LEVELING*2 + ENABLED(LEVEL_BED_CORNERS)*4 + ENABLED(AUTO_UPDATA_PROBE_Z_OFFSET) + ENABLED(OPTION_NEWAUTOLEVELING))
...
void Draw_Home_Menu(bool reset_item = true); 
void Draw_Temperature_Menu(); 
void Draw_Move_Menu(); 
void Draw_Filament_Menu();
void Draw_Leveling_Menu(bool reset_item = true); 
