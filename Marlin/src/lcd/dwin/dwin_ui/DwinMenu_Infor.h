...
#define	INFO_CASE_TOTAL	(14+ENABLED(OPTION_GUIDE_QRCODE)+ENABLED(OPTION_NEWS_QRCODE)+ENABLED(OPTION_DUALZ_DRIVE)+ENABLED(OPTION_Z2_ENDSTOP)+ENABLED(OPTION_REPEAT_PRINTING)+ENABLED(OPTION_TEST_MENU))
