...
/**
* Note: Timers define for ZONESTAR ZM3E4
SPEAKER: 	 TIMER1 (TIMER1_CH2)
TEMP: 		 TIMER2
HEATER:  	 TIMER3 (TIMER3_CH3)  
FAN:			 TIMER3 (TIMER3_CH4)
SOFT_SERIAL: TIMER4
STEPPER: 	 TIMER5
SERVO0: 	 TIMER8
**/
...
SPEAKER: 	 	TIMER1 (TIMER1_CH2)
TEMP: 		 	TIMER2
HEATER: 		TIMER3 (TIMER3 software pwm)
FAN:			 	TIMER3 (TIMER3 software pwm)
SOFT_SERIAL:TIMER4
STEPPER: 	 	TIMER5
SERVO0: 	 	TIMER8
**/
...
#if MB(BTT_SKR_MINI_E3_V1_0, BTT_SKR_E3_DIP, BTT_SKR_MINI_E3_V1_2, MKS_ROBIN_LITE,ZONESTAR_ZM3E4,ZONESTAR_ZM3E4V2,ZONESTAR_ZM3E2,ZONESTAR_ZM3E4V3)
  // SKR Mini E3 boards use PA8 as FAN_PIN, so TIMER 1 is used for Fan PWM.
  #ifdef STM32_HIGH_DENSITY
    #define SERVO0_TIMER_NUM 8  
  #else
    #define SERVO0_TIMER_NUM 3
  #endif
#else
