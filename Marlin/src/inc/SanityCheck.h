 ...
 */
  ...
  #endif
#elif ENABLED(LCD_SET_PROGRESS_MANUALLY) && NONE(HAS_MARLINUI_U8GLIB, HAS_GRAPHICAL_TFT, HAS_MARLINUI_HD44780, EXTENSIBLE_UI, ZONESTAR_DWIN_LCD)
    #error "LCD_SET_PROGRESS_MANUALLY requires LCD_PROGRESS_BAR, Character LCD, Graphical LCD, TFT, ZONESTAR_DWIN_LCD or EXTENSIBLE_UI."
#endif
 ...
 */
	...
	#if !HAS_DWIN_LCD
    #error "OPTION_ABORT_UNLOADFILAMENT requires DWIN LCD."
	#endif
	#if !BOTH(MIXING_EXTRUDER, OPTION_MIXING_SWITCH)
    #error "OPTION_ABORT_UNLOADFILAMENT requires MIXING_EXTRUDER and OPTION_MIXING_SWITCH."
	#endif
	#if DISABLED(SDSUPPORT)
	#error "OPTION_ABORT_UNLOADFILAMENT requires SDSUPPORT."	
	#endif
#endif
