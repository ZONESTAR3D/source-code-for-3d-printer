...
#if HAS_DWIN_LCD && BOTH(MIXING_EXTRUDER, OPTION_MIXING_SWITCH) && ENABLED(OPTION_ABORT_UNLOADFILAMENT)
extern float sum_extrude;
#endif
...
extern const uint32 Table_Baudrate[4];
extern uint8_t WiFi_BaudRate;
#endif
