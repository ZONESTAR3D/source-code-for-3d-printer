...
void DWIN_Draw_PrintDone_Confirm(){	
	...
	sprintf_P(timer_string, PSTR("Elapsed time:%03dH%02dM"), (int)(elapsed.hour()%1000), (uint8_t)(elapsed.minute()%60));
	DWIN_Draw_MaskString_Default_PopMenu((272 - 20 * 10) / 2, 200, PSTR(timer_string));	
	//
