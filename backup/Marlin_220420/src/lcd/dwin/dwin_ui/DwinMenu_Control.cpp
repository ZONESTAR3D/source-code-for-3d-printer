...
void Popup_Window_WiFiLink(char *strIPAddress) {
	...
	DWIN_Draw_MaskString_Default_PopMenu((272-(strlen("to control by WiFi")+1)*10)/2,95 , PSTR("to control by WiFi"));
	dwinLCD.Draw_QRCode((272-46*3)/2, 130, 3, strIPAddress);		
	DWIN_Draw_MaskString_Default_PopMenu((272-(strlen("Press the knob to exit")+1)*10)/2, 130+46*3+15, PSTR("Press the knob to exit"));
}
