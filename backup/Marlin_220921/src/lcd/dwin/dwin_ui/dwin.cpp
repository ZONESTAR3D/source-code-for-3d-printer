...
void DWIN_HandleScreen() {	
 	switch (DwinMenuID){
	  ...
	  case DWMENU_SET_HOMEOFFSET_Z:					HMI_Adjust_HomeZOffset(); break;
	#endif
	
	#if HAS_OFFSET_MENU
		case DWMENU_SET_HOMEOFFSET:						HMI_Set_HomeOffset(); break;
		case DWMENU_SET_HOMEOFFSET_X:					HMI_Adjust_HomeXOffset(); break;
		case DWMENU_SET_HOMEOFFSET_Y:					HMI_Adjust_HomeYOffset(); break;
		case DWMENU_SET_HOMEOFFSET_Z:					HMI_Adjust_HomeZOffset(); break;
	#endif
