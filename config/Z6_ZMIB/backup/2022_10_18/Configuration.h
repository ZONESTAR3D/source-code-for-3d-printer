...
#define	FIRMWARE_VERSION					"V3.9.0"
#define	STRING_DISTRIBUTION_DATE  "2022-04-01"
...
//#define PSU_NAME "Power Supply"
  ...
  //#define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    //#define AUTO_POWER_E_TEMP        50 // (¡ãC) Turn on PSU over this temperature
    //#define AUTO_POWER_CHAMBER_TEMP  30 // (¡ãC) Turn on PSU over this temperature
...
#define TEMP_WINDOW              1  // (¡ãC) Temperature proximity for the "temperature reached" timer
#define TEMP_HYSTERESIS          5  // (¡ãC) Temperature proximity considered "close enough" to the target

#define TEMP_BED_RESIDENCY_TIME 10  // (seconds) Time to wait for bed to "settle" in M190
#define TEMP_BED_WINDOW          1  // (¡ãC) Temperature proximity for the "temperature reached" timer
#define TEMP_BED_HYSTERESIS      5  // (¡ãC) Temperature proximity considered "close enough" to the target
 ...
 */
  ...
  #define JD_HANDLE_SMALL_SEGMENTS    // Use curvature estimation instead of just the junction angle
                                      // for small segments (< 1mm) with large junction angles (> 135¡ã).
#endif
 ...
 */
//#define Z_MIN_PROBE_PIN 	16 		//AUX2_SEN
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 25, 0, -3}
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP  205    // (¡ãC) Default nozzle temperature for the G26 Mesh Validation Tool.
    #define MESH_TEST_BED_TEMP      60    // (¡ãC) Default bed temperature for the G26 Mesh Validation Tool.
...
//
// MKS OLED 1.3" 128¡Á64 FULL GRAPHICS CONTROLLER
...
//
// FYSETC OLED 2.42" 128¡Á64 FULL GRAPHICS CONTROLLER with WS2812 RGB
