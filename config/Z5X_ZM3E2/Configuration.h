...
//
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
//Micro steps setting for Motor Driver
/*
Description:
  There are two pins MS1 and MS2 on the ZM3E2 control board, you can set the 
  different micro steps to get better resolution
  Hardward:
  	MS1 <->  PA13 
  	MS2 <->  PA14 
*/
