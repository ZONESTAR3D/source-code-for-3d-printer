...
#define	FIRMWARE_VERSION			  	"V5.1.0"
#define	STRING_DISTRIBUTION_DATE	  "2021-11-09"
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
//PL_08N Leveling sensor or 3D touch Leveling sensor
/*
Description:
  connect PL-08N to 
  Hardware:
 ...
 */
//#define Z_MIN_PROBE_PIN 	10 		//AUX2_SEN
